...
export default function Page() {
  return (
    <section className="flex flex-col w-full min-h-[100dvh] justify-between items-center px-5 py-16">
      ...
      <div className="flex flex-col items-center w-full">
        ...
        <Link
          href="/onBoarding/afterLogin/setNickName"
          className="w-full max-w-[19.688rem]"
        >
